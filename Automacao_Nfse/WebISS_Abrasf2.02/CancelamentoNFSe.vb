...
Namespace cWebISS2
    Public Class CancelamentoNFSe
        ...
        Public Overrides Function processar(ByVal codgCancelamento As Integer, _
            ...
            xmlCancelamento = "<soapenv:Envelope xmlns:soapenv=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:nfse=""http://nfse.abrasf.org.br"">" + _
                                  "<soapenv:Header/>" + _
                                  "<soapenv:Body>" + _
                                      "<nfse:CancelarNfseRequest>" + _
        ...
        Protected Overrides Function transmitirCancelamento(ByVal codgCidade As Integer, ByVal numrCnpj As Long, ByVal xml As String, ByVal idempresa As Integer) As String
            ...
            Try
                ...
                xmlRetorno = HTTPSoapTextRequest(certificado, doc, url, idempresa, "http://nfse.abrasf.org.br/CancelarNfse")
                responseSOAP.LoadXml(xmlRetorno)
                LogInfo("Make Cancelamento de NFSE: 10" + xmlRetorno)
                Dim node As XmlNode = responseSOAP.SelectSingleNode(GetXpathFromString("Envelope, Body, CancelarNfseResponse, outputXML"))
