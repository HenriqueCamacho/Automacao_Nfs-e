    ...
    Public Class ConsultarNfseRps
        ...
        Public Overrides Function processar(ByVal conn As IDbConnection, ByVal trans As IDbTransaction, ByVal tipoRps As Integer, ByVal serieRps As String, ByVal numeroRps As Integer, _
            ...
            Try
                ...
                xmlConsultaPorRpsEnvio = "<soapenv:Envelope xmlns:soapenv=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:nfse=""http://nfse.abrasf.org.br"">" + _
                                                       "<soapenv:Header/>" + _
                                                      "<soapenv:Body>" + _
                                                          "<nfse:ConsultarNfsePorRpsRequest>" + _
                ...
                xmlRetorno = HTTPSoapTextRequest(certificado, doc, url, idEmpresa, "http://nfse.abrasf.org.br/ConsultarNfsePorRps")
                responseSOAP.LoadXml(xmlRetorno)
                LogInfo("ConsultarNfseRps xmlConsultaPorRpsEnvio 4: " + xmlRetorno)
                Dim node As XmlNode = responseSOAP.SelectSingleNode(GetXpathFromString("Envelope, Body, ConsultarNfsePorRpsResponse, outputXML "))
