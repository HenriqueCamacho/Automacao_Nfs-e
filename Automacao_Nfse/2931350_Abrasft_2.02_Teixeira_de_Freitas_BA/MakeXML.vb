...
Namespace c2931350
    Public Class MakeXML
        ...
        Public Overrides Function processar(ByRef capa As NfseCapaData, ByRef servico As NfseServicoData, ByRef tomador As NfseTomadorData, ByRef substituido As NfseSubstituidoData, ByVal idempresa As Integer) As String
            ...
            Return CClass.StringUtil.tirarAcentos(result).Replace("<GerarNfseEnvio xmlns=""http://www.abrasf.org.br/nfse.xsd"">", "<GerarNfseEnvio xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns=""http://www.abrasf.org.br/nfse.xsd"">")
        End Function
        ...
        Private Sub popularXML(ByRef capa As NfseCapaData, ByRef servico As NfseServicoData, ByRef tomador As NfseTomadorData, ByRef substituido As NfseSubstituidoData)
            ...
            'servico.codgMunicipio = 2931350
            ' empresaData.codgCidade = 2931350
            ' tomador.codgMunicipio = 2931350
            ...
            'Teste
            If ambiente = TipoAmbiente.HOMOLOGACAO Then
                adicionaValor("Serie", dtIdentificacaoRps, "1")
            Else
            ...
            'If ambiente = TipoAmbiente.HOMOLOGACAO Then
            ' adicionaValor("DataEmissao", dtRps, "2021-10-26")
            'Else
            ...
            ' If ambiente = TipoAmbiente.HOMOLOGACAO Then
            'adicionaValor("Competencia", dtInfDeclaracaoPrestacaoServico, "2021-10-26")
            'Else
            ...
            'Essa tag não deve ser informada segundo a prefeitura de Teixeira de Freitas, pois será ela quem ira calcular esse valor - BA
            ...
            'Essa tag só deve ser informada caso o prestador seja optante pelo simples nacional e haja retenção do ISSQN
            If servico.aliquota > 0 And capa.optanteSimplesNacional = 1 And servico.issRetido = TipoIss.RETIDO Then
            ...
            Else
                adicionaValorDbNullOnEmpty("Aliquota", dtValores, Nothing, True)
            End If
            ...
            ' If ambiente = TipoAmbiente.HOMOLOGACAO Then
            ' 'adicionaValor("ItemListaServico", dtServico, "14.01")
            ' adicionaValorDbNullOnEmpty("CodigoCnae", dtServico, "4520001", False)
            'Else
            adicionaValor("ItemListaServico", dtServico, servico.codgServico.ToString().Insert(2, "."))
            ...
            'Prestador
            If ambiente = TipoAmbiente.HOMOLOGACAO Then
                adicionaValor("Cnpj", dtCpfCnpjPrestador, "07045700000303")
                adicionaValor("InscricaoMunicipal", dtPrestador, "705512")
            Else
            ...
            'If ambiente = TipoAmbiente.HOMOLOGACAO Then
            'adicionaValorDbNullOnEmpty("CodigoMunicipio", dtEnderecoTomador, "2931350", False)
            ' Else
            ...
            'If ambiente = TipoAmbiente.HOMOLOGACAO Then
            'adicionaValorDbNullOnEmpty("Uf", dtEnderecoTomador, "BA", False)
            'Else
